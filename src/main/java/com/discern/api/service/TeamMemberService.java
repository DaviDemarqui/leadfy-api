...
public class TeamMemberService {
    ...
    public Page<TeamMemberDTO> getAllTeamMembers(Long projectId, Pageable pageable) {
        CompanyValidator.validateProject(projectId, JwtAuthenticationFilter.getCurrentCompanyId());
        return teamMemberRepository.findAllByTeamProjectId(projectId, pageable)
